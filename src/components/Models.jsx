...
const Models = () => {
    ...
    const models = [
        ...
        // AgentRouter Models (High-Quality)
        {
            ...
            name: 'GPT-5.1',
            provider: 'OpenAI',
            desc: 'Latest GPT-5.1 model with enhanced reasoning.',
            context: '128k',
            tags: ['SOTA', 'Reasoning'],
            icon: <Sparkles size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'DeepSeek V3.1',
            provider: 'DeepSeek',
            desc: 'Advanced DeepSeek V3.1 coding and reasoning model.',
            context: '128k',
            tags: ['Coding', 'SOTA'],
            icon: <Code size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'DeepSeek V3.2',
            provider: 'DeepSeek',
            desc: 'Latest DeepSeek V3.2 with improved performance.',
            context: '128k',
            tags: ['Coding', 'New'],
            icon: <Code size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'DeepSeek R1',
            provider: 'DeepSeek',
            desc: 'DeepSeek R1 reasoning model for complex tasks.',
            context: '128k',
            tags: ['Reasoning', 'SOTA'],
            icon: <Sparkles size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'GLM-4.5',
            provider: 'Zhipu AI',
            desc: 'Powerful Chinese-English bilingual model.',
            context: '128k',
            tags: ['Multilingual', 'SOTA'],
            icon: <Cpu size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'GLM-4.6',
            provider: 'Zhipu AI',
            desc: 'Latest GLM model with enhanced capabilities.',
            context: '128k',
            tags: ['Multilingual', 'New'],
            icon: <Cpu size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            provider: 'Anthropic',
            desc: 'Fast and efficient Claude Haiku model.',
            context: '200k',
            tags: ['Fast', 'Efficient'],
            icon: <Zap size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            provider: 'Anthropic',
            desc: 'Balanced Claude Sonnet for complex reasoning.',
            context: '200k',
            tags: ['SOTA', 'Reasoning'],
            icon: <Sparkles size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            name: 'Gemini 3 Pro',
            provider: 'Google',
            desc: 'Preview of next-gen Gemini 3 Pro model.',
            context: '2m',
            tags: ['Preview', 'SOTA'],
            icon: <Sparkles size={24} />,
            tier: 'Pro Tier'
        },
        {
            ...
            desc: 'Advanced reasoning model with long context.',
            context: '200k',
    ...
    const providers = ['All Providers', 'DeepSeek', 'xAI', 'Qwen', 'GPT-OSS', 'Anthropic', 'OpenAI', 'Google', 'Meta', 'Mistral', 'Zhipu AI', 'Moonshot AI'];
